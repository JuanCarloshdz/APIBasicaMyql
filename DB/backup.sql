...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `addOrEditRestaurant`(
	_id varchar(255),
    _rating int,
    _name text,
    _site text,
...
/*!50003 DROP PROCEDURE IF EXISTS `deleteRestauran` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `deleteRestauran`(
	_id varchar(255)
)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `obtenerStadisticas`(
	_lat_origen float,
	_lng_origen float,
	_radius float
)
...
-- Dump completed on 2020-11-26 10:59:46
